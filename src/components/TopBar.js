        ...
        return (
            <div>
                <div className="center-content showcase showcase-padding">
                    ...
                    <Link hidden={window.location.pathname !== "/" ? true : false} to="/demo" className="btn systemManagerButton top-buttons">Demo</Link>
                    <Link hidden={window.location.pathname !== "/" ? true : false} to="/documentation/getstarted" className="btn systemManagerButton top-buttons">Get started</Link>
                </div>
            </div>
        )
    }
