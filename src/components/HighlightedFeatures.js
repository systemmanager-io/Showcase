        ...
        return (
            <div className="flex flex-wrap">
                <div className="w-full md:w-6/12 lg:w-4/12">
                    <div className="bg-white rounded overflow-hidden shadow-lg lg:m-4">
                        <div className="px-6 py-4">
                            <div className="text-black font-bold text-2xl mb-2">Security</div>
                            <hr/>
                ...
                <div className="w-full md:w-6/12 lg:w-4/12">
                    <div className="bg-white rounded overflow-hidden shadow-lg lg:m-4">
                        <div className="px-6 py-4">
                            <div className="text-black font-bold text-2xl mb-2">User Friendly</div>
                            <hr/>
                            <p className="text-gray-700 text-base">No difficult interfaces! We crafted one beautiful panel to manage every server with! Do
                                you
                ...
                <div className="w-full md:w-6/12 lg:w-4/12">
                    <div className="bg-white rounded overflow-hidden shadow-lg lg:m-4">
                        <div className="px-6 py-4">
                            <div className="text-black font-bold text-2xl mb-2">Native Apps</div>
                            <hr/>
                ...
                <div className="w-full md:w-6/12 lg:w-4/12">
                    <div className="bg-white rounded overflow-hidden shadow-lg lg:m-4">
                        <div className="px-6 py-4">
                            <div className="text-black font-bold text-2xl mb-2">Free and Opensource</div>
                            <hr/>
                ...
                <div className="w-full md:w-6/12 lg:w-4/12">
                    <div className="bg-white rounded overflow-hidden shadow-lg lg:m-4">
                        <div className="px-6 py-4">
                            <div className="text-black font-bold text-2xl mb-2">Lightweight</div>
                            <hr/>
